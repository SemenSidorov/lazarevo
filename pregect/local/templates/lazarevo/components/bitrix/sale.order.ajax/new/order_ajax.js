		...
		alterProperty: function(settings, propContainer)
		{
			...
			if (textNode)
			{
				...
				if(settings.ID == 5){
					...
					var selectNewStr = '<select name="ORDER_PROP_5" id="soa-property-5"><option></option>';
					for(var UserOrg in UserOrgList){
						selectNewStr += "<option>" + UserOrgList[UserOrg] + "</option>";
					}
					selectNewStr += "</select>";
					$(textNode).replaceWith(selectNewStr);
				}
