...
<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
	<div class="fields">
		...
		<input type="text" name="NAME" placeholder="<?=GetMessage('NAME')?>" value="<?=$arResult["arUser"]["NAME"]?>" />
		<input type="text" name="LAST_NAME" placeholder="<?=GetMessage('LAST_NAME')?>" value="<?=$arResult["arUser"]["LAST_NAME"]?>" />
		<input type="text" name="SECOND_NAME" placeholder="<?=GetMessage('SECOND_NAME')?>" value="<?=$arResult["arUser"]["SECOND_NAME"]?>" />
		<input type="text" name="LOGIN" placeholder="<?=GetMessage('LOGIN')?>" value="<?=$arResult["arUser"]["LOGIN"]?>" />
		<input type="text" name="EMAIL" placeholder="<?=GetMessage('EMAIL')?>" value="<?=$arResult["arUser"]["EMAIL"]?>" />
		<input type="text" name="PERSONAL_PHONE" placeholder="<?=GetMessage('USER_PHONE')?>" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" />
		<input type="password" name="NEW_PASSWORD" placeholder="<?=GetMessage('NEW_PASSWORD_REQ')?>" value="" autocomplete="off" class="bx-auth-input" />
		<input type="password" name="NEW_PASSWORD_CONFIRM" placeholder="<?=GetMessage('NEW_PASSWORD_CONFIRM')?>" value="" autocomplete="off" />
